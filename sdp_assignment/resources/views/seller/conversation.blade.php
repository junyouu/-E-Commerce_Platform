...
<body>
        ...
        <div class="chat-container">
            <div class="chat-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-0">Seller Side Conversation</h1>
                        <h2 class="h5 mb-0">{{$customer->name}}</h2>
                    </div>
                    <a href="{{ route('seller.index') }}" class="btn btn-light">Back to Main Page</a>
                </div>
            </div>
    ...
    <script>
        var seller_id = "{{ session('seller_id') }}";
        // Initialize Pusher
        ...
        var channel_name = 'chat.' + seller_id + '_' + {{$customer->customer_id}}; 
        ...
        $('#message-form').submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('seller.send_message', ['customer_id' => $customer->customer_id]) }}",
                method: 'POST',
                headers: {
